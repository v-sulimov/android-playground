...
sealed class EventsAction : Action {
     ...
     */
    data class SaveEvent(val eventDetails: String) : EventsAction()
     ...
     */
    data class DeleteEvent(val eventTimestamp: Long) : EventsAction()
     ...
     */
    data class UpdateEventsList(val newEvents: List<EventState>) : EventsAction()
}
