...
import com.vsulimov.playground.state.OverlayState.Dialog.DeleteEvent
...
class EventsListAdapter : RecyclerView.Adapter<EventsListAdapter.ViewHolder>() {
     ...
     */
    private val diffUtil = object : DiffUtil.ItemCallback<EventState>() {
        /**
         ...
         */
        override fun areItemsTheSame(oldItem: EventState, newItem: EventState): Boolean =
         ...
         */
        override fun areContentsTheSame(oldItem: EventState, newItem: EventState): Boolean =
            oldItem == newItem
    }
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder =
        ViewHolder(LayoutInflater.from(viewGroup.context).inflate(R.layout.item_event, viewGroup, false))
